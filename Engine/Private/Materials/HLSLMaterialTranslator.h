...
protected:
	...
	TArray<FString> CustomExpressionImplementations;//[HTH]
...
protected:
	...
	virtual FString GetParameterCode(int32 Index, const TCHAR* Default = 0) override;//[HTH]
...
protected:
	...
	*/	
	...
	//++[HTH]
	virtual TArray<FString>& GetCustomExpressionImplementations() override { return CustomExpressionImplementations;}
	//--[HTH]
