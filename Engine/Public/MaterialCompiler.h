...
public:
	...
	//++[HTH]
	virtual TArray<FString>& GetCustomExpressionImplementations() = 0;
	virtual FString GetParameterCode(int32 Index, const TCHAR* Default = 0) = 0;
	virtual	int32 AddCodeChunk(EMaterialValueType Type, const TCHAR* Format, ...) = 0;
	//--[HTH]
...
public:
	...
	//++[HTH]
	virtual TArray<FString>& GetCustomExpressionImplementations() { return Compiler->GetCustomExpressionImplementations(); }
	virtual FString GetParameterCode(int32 Index, const TCHAR* Default = 0) { return Compiler->GetParameterCode(Index, Default); }
	virtual	int32 AddCodeChunk(EMaterialValueType Type, const TCHAR* Format, ...)
	{
		va_list ArgPtr;
		va_start(ArgPtr, Format);
		return Compiler->AddCodeChunk(Type, Format, ArgPtr);
		va_end(ArgPtr);
	}
	//--[HTH]
